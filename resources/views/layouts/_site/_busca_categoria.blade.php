  ...
  <div class="col-md-6 no-padding-left">
    <div class="row">
      <div class="headerback col-md-12">
        <h1>
          <div class="margin-center titulo">Autodicas</div>
          <div class="hidden-xs margin-center sub-titulo">O maior classificado automotivo do Brasil</div>
        </h1>
        <div class="search" id="pillsearch">

          <form method="get" role="form" action="/filtro">
            <div class="row">
              <div class="col-md-12 searchtext style">
                <input name="produto" type="text" placeholder="O que procura?" class="form-control input-lg-nomobile">
              </div>
              <div class="col-md-12 no-padding-left no-padding-right searchselect">
                <div class="row">
                  <div class="col-xs-12 searchcat no-shadows">
                  ...
                  <div class="col-xs-12 searchloc no-shadows">

                   <div class="selectie big">
                   
                    <select name="cidade_id" title="Clique para mudar a região" class="form-control style">

                      <option value="" data-seo="brasil" selected="">Todos</option>
...
<div class="col-md-6 hidden-xs hidden-sm no-padding-right maparegions">
      ...
      <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="450px" height="460px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
        <g>
          ...
          <a xlink:href="#sergipe" class="estado" name="Sergipe" code="28">
            ...
            <text transform="matrix(1 0 0 1 408.9121 198.6689)" fill="#333">SE</text>
          ...
          <a xlink:href="#alagoas" class="estado" name="Alagoas" code="27">
            ...
            <text transform="matrix(1 0 0 1 429.7891 183.895)" fill="#333">AL</text>
          </a>

          <a xlink:href="#riograndedonorte" class="estado" name="Rio Grande do Norte" code="24">
            <path stroke="#FFFFFF" stroke-width="1.0404"  d="M404.698,138.795
            c2.383-4.027,6.574-6.123,8.49-11.149c1.973-5.107,3.834-5.818,8.764-4.642c5.041,1.207,9.339,0.837,14.57,1.671
            c7.534,1.193,6.848,10.968,9.206,16.516c-1.919,1.096-13.972,0.521-15.064-1.657c-1.041-2.067-2.904,7.107-5.094,7.3
            c1.532-5.847-12.654,1.78-5.424-8.683c2.545-3.67-6.302-0.808-6.711,0.725C410.121,144.013,407.217,139.151,404.698,138.795z"></path>

            <text transform="matrix(1 0 0 1 422.541 123.9009)" fill="#333">RN</text>
          </a>
          ...
          <a xlink:href="#paraiba" class="estado" name="Paraíba" code="25">
            ...
            <text transform="matrix(1 0 0 1 425.2129 148.9893)" fill="#333">PB</text>
          </a>
        </g>
      </svg>
    </div>
